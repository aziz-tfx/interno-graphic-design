...
window.INTERNO_PROMO = {
  ...
  nav: 'header',        // шапка, которую баннер сдвигает вниз
  target: '#signup',    // куда плавно скроллим по клику
  offerBefore: '#signup', // перед каким блоком PromoOffer.js вставит карточку
  displayFont: "var(--serif,'Playfair Display',serif)"
};
